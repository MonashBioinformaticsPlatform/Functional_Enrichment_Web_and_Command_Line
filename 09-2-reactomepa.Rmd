...
## ReactomePA Functional Class Scoring
...
## Plotting exported network and expression data using ggplot
...
```{r make node coords for network plot, include=TRUE}
...
node_layout$LFC <- pezzini$Differentiated[ match(node_layout$node, pezzini$Gene.Name)]
```
...
```{r plot pretty pathway, include=TRUE}
