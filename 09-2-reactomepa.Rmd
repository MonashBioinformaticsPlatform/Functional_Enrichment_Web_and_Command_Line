...
Raw data from [ et al 2017](https://link.springer.com/article/10.1007/s10571-016-0403-y) was subjected to differential gene expression analysis with [Degust](https://degust.erc.monash.edu/) and the results file saved to `_DE.txt`.
...
The dataframe shows genes with fold change and FDR values, along with gene counts values for the 6 samples (2 groups with 3 replicates each). 
