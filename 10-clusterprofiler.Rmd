...
```{r check notebook workdir, eval=TRUE}
...
```{r rstudio version - not run during knit clusterprofiler, eval=FALSE}
...
```{r rstudio version saved from text clusterprofiler, eval=FALSE}
...
<img src="images/poll-favourite-plot-type.png" class="screenshot screenshot-full">
